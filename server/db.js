...
const STARTER_PARTS = [
  ...
  // ---- CPUs: LGA1700 (DDR5) ----
  { id: "c14", category: "cpu", name: "Intel Core i5-13600K", price: 259, specs: { socket: "LGA1700", ramType: "DDR5", tdp: 125, tier: "Gaming" } },
  { id: "c15", category: "cpu", name: "Intel Core i5-14600K", price: 269, specs: { socket: "LGA1700", ramType: "DDR5", tdp: 125, tier: "Gaming" } },
  { id: "c16", category: "cpu", name: "Intel Core i7-13700K", price: 349, specs: { socket: "LGA1700", ramType: "DDR5", tdp: 125, tier: "High-end" } },
  { id: "c17", category: "cpu", name: "Intel Core i7-14700K", price: 379, specs: { socket: "LGA1700", ramType: "DDR5", tdp: 125, tier: "High-end" } },
  { id: "c18", category: "cpu", name: "Intel Core i9-13900K", price: 529, specs: { socket: "LGA1700", ramType: "DDR5", tdp: 125, tier: "Enthusiast" } },
  { id: "c19", category: "cpu", name: "Intel Core i9-14900K", price: 549, specs: { socket: "LGA1700", ramType: "DDR5", tdp: 125, tier: "Enthusiast" } },
  ...
  { id: "m4", category: "motherboard", name: "MSI MPG B650 Edge WiFi", price: 219, specs: { socket: "AM5", ramType: "DDR5", formFactor: "ATX" } },
  { id: "m5", category: "motherboard", name: "Gigabyte X670 AORUS Elite AX", price: 269, specs: { socket: "AM5", ramType: "DDR5", formFactor: "ATX" } },
  { id: "m6", category: "motherboard", name: "ASUS ROG Strix X670E-E Gaming", price: 449, specs: { socket: "AM5", ramType: "DDR5", formFactor: "ATX" } },

  // ---- Motherboards: AM4 (DDR4) ----
  { id: "m7", category: "motherboard", name: "MSI B450 Tomahawk Max", price: 99, specs: { socket: "AM4", ramType: "DDR4", formFactor: "ATX" } },
  { id: "m8", category: "motherboard", name: "Gigabyte B450 AORUS M", price: 89, specs: { socket: "AM4", ramType: "DDR4", formFactor: "mATX" } },
  { id: "m9", category: "motherboard", name: "ASRock B550M Pro4", price: 99, specs: { socket: "AM4", ramType: "DDR4", formFactor: "mATX" } },
  { id: "m10", category: "motherboard", name: "ASUS ROG Strix B550-F Gaming", price: 159, specs: { socket: "AM4", ramType: "DDR4", formFactor: "ATX" } },

  // ---- Motherboards: LGA1700 (DDR5) ----
  { id: "m11", category: "motherboard", name: "MSI PRO B760M-A WiFi", price: 139, specs: { socket: "LGA1700", ramType: "DDR5", formFactor: "mATX" } },
  { id: "m12", category: "motherboard", name: "ASRock B760M Pro RS", price: 129, specs: { socket: "LGA1700", ramType: "DDR5", formFactor: "mATX" } },
  { id: "m13", category: "motherboard", name: "ASUS Prime Z790-P WiFi", price: 199, specs: { socket: "LGA1700", ramType: "DDR5", formFactor: "ATX" } },
  { id: "m14", category: "motherboard", name: "Gigabyte Z790 AORUS Elite AX", price: 259, specs: { socket: "LGA1700", ramType: "DDR5", formFactor: "ATX" } },

  // ---- RAM: DDR5 ----
  { id: "r1", category: "ram", name: "Kingston Fury Beast 16GB (2x8GB) DDR5-5600", price: 59, specs: { type: "DDR5", capacity: "16GB" } },
  { id: "r2", category: "ram", name: "Corsair Vengeance 32GB (2x16GB) DDR5-6000", price: 89, specs: { type: "DDR5", capacity: "32GB" } },
  { id: "r3", category: "ram", name: "G.Skill Flare X5 32GB (2x16GB) DDR5-6000", price: 94, specs: { type: "DDR5", capacity: "32GB" } },
  { id: "r4", category: "ram", name: "G.Skill Trident Z5 32GB (2x16GB) DDR5-6400", price: 119, specs: { type: "DDR5", capacity: "32GB" } },
  { id: "r5", category: "ram", name: "Corsair Vengeance 64GB (2x32GB) DDR5-6000", price: 179, specs: { type: "DDR5", capacity: "64GB" } },

  // ---- RAM: DDR4 ----
  { id: "r6", category: "ram", name: "Kingston Fury Beast 16GB (2x8GB) DDR4-3200", price: 39, specs: { type: "DDR4", capacity: "16GB" } },
  { id: "r7", category: "ram", name: "Corsair Vengeance LPX 16GB (2x8GB) DDR4-3200", price: 42, specs: { type: "DDR4", capacity: "16GB" } },
  { id: "r8", category: "ram", name: "G.Skill Ripjaws V 32GB (2x16GB) DDR4-3600", price: 74, specs: { type: "DDR4", capacity: "32GB" } },
  { id: "r9", category: "ram", name: "Corsair Vengeance LPX 32GB (2x16GB) DDR4-3600", price: 79, specs: { type: "DDR4", capacity: "32GB" } },
  ...
  // ---- Storage ----
  { id: "s1", category: "storage", name: "Kingston NV2 1TB NVMe SSD", price: 54, specs: { capacity: "1TB" } },
  { id: "s2", category: "storage", name: "WD Blue SN580 500GB NVMe SSD", price: 39, specs: { capacity: "500GB" } },
  { id: "s3", category: "storage", name: "WD Black SN770 1TB NVMe SSD", price: 69, specs: { capacity: "1TB" } },
  { id: "s4", category: "storage", name: "Samsung 990 Pro 1TB NVMe SSD", price: 89, specs: { capacity: "1TB" } },
  { id: "s5", category: "storage", name: "Samsung 990 Pro 2TB NVMe SSD", price: 149, specs: { capacity: "2TB" } },
  { id: "s6", category: "storage", name: "Crucial P3 Plus 4TB NVMe SSD", price: 259, specs: { capacity: "4TB" } },
  { id: "s7", category: "storage", name: "Seagate BarraCuda 2TB HDD", price: 54, specs: { capacity: "2TB" } },

  // ---- PSUs ----
  { id: "p1", category: "psu", name: "Corsair CV550 550W 80+ Bronze", price: 54, specs: { wattage: 550 } },
  { id: "p2", category: "psu", name: "Corsair RM650e 650W 80+ Gold", price: 89, specs: { wattage: 650 } },
  { id: "p3", category: "psu", name: "EVGA SuperNOVA 750 GT 750W 80+ Gold", price: 109, specs: { wattage: 750 } },
  { id: "p4", category: "psu", name: "MSI MPG A850G 850W 80+ Gold", price: 129, specs: { wattage: 850 } },
  { id: "p5", category: "psu", name: "Corsair RM850x 850W 80+ Gold", price: 139, specs: { wattage: 850 } },
  { id: "p6", category: "psu", name: "Corsair RM1000e 1000W 80+ Gold", price: 159, specs: { wattage: 1000 } },

  // ---- Cases ----
  { id: "cs1", category: "case", name: "Cooler Master MasterBox NR200", price: 99, specs: { formFactorSupport: ["ITX"], maxGpuLengthMM: 330 } },
  { id: "cs2", category: "case", name: "NZXT H5 Flow", price: 89, specs: { formFactorSupport: ["ATX", "mATX", "ITX"], maxGpuLengthMM: 365 } },
  { id: "cs3", category: "case", name: "Fractal Design Pop Air", price: 99, specs: { formFactorSupport: ["ATX", "mATX", "ITX"], maxGpuLengthMM: 355 } },
  { id: "cs4", category: "case", name: "Lian Li Lancool 216", price: 109, specs: { formFactorSupport: ["ATX", "mATX", "ITX"], maxGpuLengthMM: 392 } },
  { id: "cs5", category: "case", name: "Corsair 4000D Airflow", price: 104, specs: { formFactorSupport: ["ATX", "mATX", "ITX"], maxGpuLengthMM: 360 } },
  { id: "cs6", category: "case", name: "Fractal Design North", price: 149, specs: { formFactorSupport: ["ATX", "mATX", "ITX"], maxGpuLengthMM: 355 } },
  { id: "cs7", category: "case", name: "NZXT H7 Flow", price: 129, specs: { formFactorSupport: ["ATX", "mATX", "ITX"], maxGpuLengthMM: 400 } },

  // ---- Coolers ----
  { id: "co1", category: "cooler", name: "Thermalright Peerless Assassin 120 SE", price: 35, specs: { supportedSockets: ["AM5", "AM4", "LGA1700"] } },
  { id: "co2", category: "cooler", name: "Cooler Master Hyper 212 Halo", price: 45, specs: { supportedSockets: ["AM5", "AM4", "LGA1700"] } },
  { id: "co3", category: "cooler", name: "be quiet! Dark Rock 4", price: 74, specs: { supportedSockets: ["AM5", "AM4", "LGA1700"] } },
  { id: "co4", category: "cooler", name: "Corsair iCUE H100i 240mm AIO", price: 129, specs: { supportedSockets: ["AM5", "AM4", "LGA1700"] } },
  { id: "co5", category: "cooler", name: "NZXT Kraken 280mm AIO", price: 169, specs: { supportedSockets: ["AM5", "AM4", "LGA1700"] } },
  { id: "co6", category: "cooler", name: "Corsair iCUE H150i 360mm AIO", price: 199, specs: { supportedSockets: ["AM5", "AM4", "LGA1700"] } },
];
